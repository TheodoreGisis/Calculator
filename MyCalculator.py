...
#creating the frame to show the total and current results
        self.display_frame =self.create_display_frame()
        self.buttom_fame = self.create_buttom_frame()
#here me are making the buttoms to fill all the window
...
#starting to create the buttoms
        self.create_buttom()
    ...
    def create_clear_buttom(self):
            ...
            buttom = tk.Button(self.buttom_fame,text="C",font=("Arial",20),bg="tomato2",borderwidth=1,command=lambda:self.clear_button_functionality())
    ...
    def create_riza_buttom(self):
        buttom = tk.Button(self.buttom_fame,text="\u221ax",font=("Arial",20),bg=WHITE,borderwidth=0,command=lambda:self.riza())
